...
func (p *EVMModule) Start(block iblockproc.BlockCtx, statedb *state.StateDB, reader evmcore.DummyChain, onNewLog func(*types.Log), net opera.Rules, chainCfg *params.ChainConfig, vmCfg vm.Config) blockproc.EVMProcessor {
